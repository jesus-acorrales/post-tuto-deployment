...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str,
                        default='../src/scraping/scrapy/comments_trustpilot.csv ')
    parser.add_argument('--validation_split', type=float, default=0.1)
    parser.add_argument('--label_column', type=str, default='rating')
    ...
    parser.add_argument('--model_name', type=str, default='trustpilot')
